...
const fs = require('fs');
const { setMockedResponse , getBestMediaType, pathMatches, getOperation } = require("../response-mocker.cjs");
...
const petStoreSpec = fs.readFileSync('../../../utils/testdata/specs/oas3/petstore/oas3.json', 'utf8');

describe("response-mocker-unit", (done) => {
...
<root>
 ...
 <Cgfbg>48409</Cgfbg>
  ...
  test("post /user/createWithList (seeded, mock-status: default, accept: null) | default ", (done) => {
    let seed = 2432976933;
